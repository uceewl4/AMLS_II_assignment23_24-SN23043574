...
class BaseGAN(Model):
    ...
    def genNet(self):
        ...
        model.add(Conv2D(3, 4, padding='same', activation='sigmoid')) # 3 channel
  ...
  """
    ...
    def train(self, model, Xtrain):
        ...
        self.discriminator.save('Outputs/image_generation/models/baseGAN_disciriminator.h5')
  ...
  """
    ...
    def generate(self):
        ...
        self.generator.load_weights('Outputs/image_generation/models/baseGAN_generator.h5')
