...
if __name__ == "__main__":
    ...
    pre_path = "datasets/pencil/" if method in ["PencilGAN"] else "datasets/preprocessed/"
    ...
    elif method in ["ViT","ConGAN","AutoEncoder","AdvCNN","BaseGAN","PencilGAN","ResNet50","InceptionV3","MobileNetV2","NASNetMobile","VGG19"]:
    ...
    elif method in ["AutoEncoder","ViT","AdvCNN","ConGAN","PencilGAN","BaseGAN","MoE","ResNet50","InceptionV3","MobileNetV2","NASNetMobile","VGG19","Mulitmodal"]:
    ...
    if method in ["CNN"]:
        ...
        train_res, val_res, pred_train, ytrain, pred_val, yval = model.train(Xtrain, ytrain, Xval, yval)
    ...
    if method in ["AdvCNN","ResNet50","InceptionV3","MobileNetV2","NASNetMobile","VGG19"]:
        visual4loss(method,"train",train_res["train_loss"],train_res["train_acc"])
