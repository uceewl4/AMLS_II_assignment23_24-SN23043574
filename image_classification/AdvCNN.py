  ...
  """
    ...
    def train(self, Xtrain, ytrain, Xval, yval):
        ...
        for index,img in enumerate(Xtrain_adv.tolist()):
            cv2.imwrite(os.path("Datasets/adversarial/train",f"{ytrain_adv[index]}_{index}.JPG"),np.array(img))  # 0_0
        ...
        # save adv
        for index,img in enumerate(Xtrain_adv.tolist()):
            cv2.imwrite(os.path("Datasets/adversarial/val",f"{yval_adv[index]}_{index}.JPG"),np.array(img))  # 0_0
  ...
  """
    ...
    def test(self, Xtest, ytest):
        ...
        for index,img in enumerate(Xtest_adv.tolist()):
            cv2.imwrite(os.path("Datasets/adversarial/test",f"{ytest_adv[index]}_{index}.JPG"),np.array(img))  # 0_0
